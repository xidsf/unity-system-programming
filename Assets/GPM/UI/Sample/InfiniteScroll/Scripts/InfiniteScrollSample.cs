namespace Gpm.Ui.Sample
{
    ...
    public class InfiniteScrollSample : MonoBehaviour
    {
        ...
        private void MoveToItemIndex(int itemIndex)
        {
            ...
            verticalScrollList.MoveTo(itemIndex, (InfiniteScroll.MoveToType)moveDataTypeSelect.value, new InfiniteScroll.CurveFromType(curveType, time));
            horizontalScrollList.MoveTo(itemIndex, (InfiniteScroll.MoveToType)moveDataTypeSelect.value, new InfiniteScroll.CurveFromType(curveType, time));
        ...
        private void MoveToDataIndex(int dataIndex)
        {
            ...
            {
                verticalScrollList.MoveToFromDataIndex(dataIndex, (InfiniteScroll.MoveToType)moveDataTypeSelect.value, new InfiniteScroll.CurveFromType(curveType, time));
                horizontalScrollList.MoveToFromDataIndex(dataIndex, (InfiniteScroll.MoveToType)moveDataTypeSelect.value, new InfiniteScroll.CurveFromType(curveType, time));
            }
            else
            {
                TestItemData data = dataList[dataIndex];

                verticalScrollList.MoveTo(data, (InfiniteScroll.MoveToType)moveDataTypeSelect.value, new InfiniteScroll.CurveFromType(curveType, time));
                horizontalScrollList.MoveTo(data, (InfiniteScroll.MoveToType)moveDataTypeSelect.value, new InfiniteScroll.CurveFromType(curveType, time));
            }
